function dstate = AdaptiveBacksteppingControl(t, state)
%ADAPTIVEBACKSTEPPINGCONTROL Summary of this function goes here
%   Detailed explanation goes here
    ...
    z2 = e2 + K1*z1;
    parvar_dot = -Gp*Y'*z2;
    tau = Y*parvar_est - z1 - K2*z2;
    q_ddot = inv(M)*(tau - C*q - G_0);

    dstate = [q_dot; q_ddot;parvar_dot];
end
