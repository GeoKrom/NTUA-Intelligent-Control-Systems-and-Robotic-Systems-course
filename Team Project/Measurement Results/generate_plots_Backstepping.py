...
CSV_FILENAME = "teamB/Backstepping_Output.csv"
THETA_1_POS = 12
THETA_2_POS = 13
THETA_3_POS = 14
...
theta1 = [float(x[THETA_1_POS].strip().replace("'", ""))/1000 for x in state]
theta2 = [float(x[THETA_2_POS].strip().replace("'", ""))/1000 for x in state]
beta = [float(x[THETA_3_POS].strip().replace("'", ""))/1000 for x in state]
